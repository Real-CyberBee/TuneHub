...
> **English summary:** `@tunehub/ambient@1.0.0` is TuneHub’s first reviewed, built-in content pack. Packs declare versioned metadata and local references; the registry validates compatibility and does not execute code fetched from arbitrary URLs.
>
> **中文补充：** `@tunehub/ambient@1.0.0` 是首个内置内容包，随应用发布并经过审核。
