...
英文主文档位于 `docs/`；本目录提供中文补充版本。

- [项目 README](README.md)：运行项目与当前功能。
- [产品概览](OVERVIEW.md)：产品目标、交互方式、AI 方向与内容理念。
- [架构设计](ARCHITECTURE.md)：内核、内容包、Action 协议与技术边界。
- [路线图](ROADMAP.md)：阶段状态与验收标准。
